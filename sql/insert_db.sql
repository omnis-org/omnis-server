...
CALL insert_machine("AD01","AD01","ActiveDirectory domain controller",NULL,"012345",1,2,3,"client", "1.0", 1);
CALL insert_machine("FILE-SHARE01","FILE-SHARE01","File sharing server",NULL,"012445",1,2,3,"client", "1.0", 1);
CALL insert_machine("AD01-PCA","AD01-PCA","ActiveDirectory domain controller redondant",NULL,"012346",1,1,3,"client", "1.0", 1);
CALL insert_machine("FILE-SHARE01-PCA","FILE-SHARE-PCA01","File sharing server","Docker","012347",1,1,3,"client", "1.0", 1);
CALL insert_machine("BACKUP01-DOMAIN","BACKUP01-DOMAIN","machine de backup décorélée des autres SI","Podman","29931",2,2,3,"client",NULL, 1);
CALL insert_machine("BACKUP01-DOMAIN-PCA","BACKUP02-DOMAIN-PCA","machine de backup dédiée au site de PCA et décorélée des autres SI","Virtualbox","29431",2,1,3,"client",NULL, 1);
CALL insert_machine("user01","user01","Domain user computer",NULL,"012315",1,3,2,"client", "1.0", 1);
CALL insert_machine("user02","user02","Domain user computer",NULL,"012325",1,3,2,"client", "1.0", 1);
CALL insert_machine("user03","user03","Domain user computer",NULL,"012335",1,3,2,"client", "1.0", 1);
CALL insert_machine("user04","user04","Domain user computer",NULL,"012345",1,3,2,"client", "1.0", 1);
CALL insert_machine("user05","user05","Domain user computer",NULL,"012355",1,3,2,"client", "1.0", 1);
